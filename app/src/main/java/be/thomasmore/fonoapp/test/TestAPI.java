...
public class TestAPI {
    ...
    public TestAPI() {
        ...
        this.ageRanges.add(new AgeRange(1, 5, 6));
        ...
        this.wordPairs.add(new WordPair(1, 11, 12, 3, 2));
        this.wordPairs.add(new WordPair(1, 13, 14, 3, 2));
    ...
    public ArrayList<WordPairType> getWordpairsTypeByDisorderType(int DisorderId) {
    ...
    public ArrayList<WordPair> getWordpairsByWPTandAge(int wpt, int age) {
