...
public class TestAPI {
    ...
    public TestAPI() {
        ...
        this.words.add(new Word("2", "Peer", "main_peer", "img_peer2", "peer.m4a", "De jonge eet zijn...", "peer_zin.m4a"));
        this.words.add(new Word("3", "Baard", "main_baard", "img_baard2", "woord-baard.m4ard.m4a", "Deze man heeft een lange...", "baard_zin.m4a"));
